...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230714143924-b7cf1144d8d3
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230714141630-cdbba76c049d => ../sdk-go
