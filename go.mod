...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230223124558-9fc7f23ffe38
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230211154436-188182830914 => ../sdk-go
