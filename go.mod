...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20250521125555-a61b8b4fbf03
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20250521124441-bd232d406413 => ../sdk-go
