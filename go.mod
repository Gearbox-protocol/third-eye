...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20251204191947-bb07f4d2d630
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20251202045556-c3b8708459fd => ../sdk-go
