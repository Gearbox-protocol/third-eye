...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20250402041418-0d9e3b64ec55
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20241021192611-afbca24394b5 => ../sdk-go
