...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230526103024-e2a8cd11e795
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230510073004-907e493128ce => ../sdk-go
