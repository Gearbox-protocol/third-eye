...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20240502053900-e8566ba5a17c
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20240428043014-356d3ee39256 => ../sdk-go
