...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230211154436-188182830914
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230209171357-3048e2597dcf => ../sdk-go
