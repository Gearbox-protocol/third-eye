...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20251124220411-11f3e9b83ccb
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20251124200255-d893678ae0e8 => ../sdk-go
