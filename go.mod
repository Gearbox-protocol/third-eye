...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20231017075038-462ee137b39d
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20231009185829-3e1a770ba3db => ../sdk-go
