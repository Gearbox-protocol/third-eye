...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20231009185829-3e1a770ba3db
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20231008155324-f40cbfb8f556 => ../sdk-go
