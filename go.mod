...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20221108090151-9d6c9e055a4a
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20221108090151-9d6c9e055a4a => ../sdk-go
