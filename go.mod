...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20220922192220-467ba5a38c92
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20220922192220-467ba5a38c92 => ../sdk-go
