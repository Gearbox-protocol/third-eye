...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230119092924-ffd20caa3339
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230119092924-ffd20caa3339 => ../sdk-go
