...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20221006160613-646e349926e0
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20221006160613-646e349926e0 => ../sdk-go
