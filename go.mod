...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20250613020729-fb0cd12f3a80
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20250603043334-2406c3582614 => ../sdk-go
