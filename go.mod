...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230906091105-c182238cd0fc
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230906035602-854c3d196bae => ../sdk-go
