...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20220715143017-bc5061d0284b
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20220715143017-bc5061d0284b => ../sdk-go
