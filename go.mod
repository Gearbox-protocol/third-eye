...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20220922074603-b95ccb3995ed
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20220922074603-b95ccb3995ed => ../sdk-go
