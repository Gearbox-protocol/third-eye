...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230504131559-c24cac004ab8
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230420114939-247ecb0031c4 => ../sdk-go
