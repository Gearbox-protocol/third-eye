...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20250730115226-7bd55f1139fd
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20250729095450-2120a2e51497 => ../sdk-go
