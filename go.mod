...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20220920234427-076164d6ddf9
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20220920234427-076164d6ddf9 => ../sdk-go
