...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20221208062547-aa9b249252d0
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20221208062547-aa9b249252d0 => ../sdk-go
