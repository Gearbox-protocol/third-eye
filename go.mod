...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20230713090141-382d47a57b1c
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20230628113824-c178d681ec24 => ../sdk-go
