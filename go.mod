...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20220922115437-794d8c0f47cc
...
// replace github.com/Gearbox-protocol/sdk-go v0.0.0-20220922115437-794d8c0f47cc => ../sdk-go
