...
require (
	github.com/Gearbox-protocol/sdk-go v0.0.0-20250624080436-2902355fcd4b
...
replace github.com/Gearbox-protocol/sdk-go v0.0.0-20250613020729-fb0cd12f3a80 => ../sdk-go
